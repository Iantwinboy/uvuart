...
function pano2vrSkin(player,base) {
	...
	player.addVariable('vis_popup', 2, false);
	...
	player.addVariable('vis_phone_nodes', 2, false);
	...
	player.addVariable('opt_autorotation', 2, true);
	player.addVariable('opt_gyro', 2, true);
	player.addVariable('opt_maps', 2, false);
	player.addVariable('opt_floorplans', 2, false);
	player.addVariable('opt_share_facebook', 2, false);
	player.addVariable('opt_share_twitter', 2, false);
	player.addVariable('opt_share_copy', 2, false);
	player.addVariable('opt_share', 2, false);
	player.addVariable('opt_url_popup', 2, true);
	player.addVariable('pos_menu_button', 1, 0);
	player.addVariable('pos_share_button', 1, 0);
	player.addVariable('pos_languages', 1, 0);
	player.addVariable('pos_info', 1, 0);
	player.addVariable('pos_share', 1, 0);
	player.addVariable('pos_map', 1, 0);
	player.addVariable('pos_floorplan', 1, 0);
	player.addVariable('has_fullscreen', 2, true);
	player.addVariable('has_categories', 2, true);
	player.addVariable('categories_cloner_hasUp', 2, true);
	player.addVariable('categories_cloner_hasDown', 2, true);
	...
	this.addSkin=function() {
		...
		me._control_buttons.logicBlock_visible = function() {
			...
			if (me._control_buttons.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				me._control_buttons.style[domTransition]='opacity 500ms ease 0ms';
		...
		hs='data:image/svg+xml;base64,'+
		...
		me._floorplan_btn.logicBlock_visible = function() {
			...
			if (me._floorplan_btn.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				me._floorplan_btn.style[domTransition]='';
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
		...
		elo.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
		...
		me._map_btn.logicBlock_visible = function() {
			...
			if (me._map_btn.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				me._map_btn.style[domTransition]='';
		...
		me._info_btn.logicBlock_visible = function() {
			...
			if (me._info_btn.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				me._info_btn.style[domTransition]='';
		...
		me._info_btn_disabled.logicBlock_visible = function() {
			...
			if (me._info_btn_disabled.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				me._info_btn_disabled.style[domTransition]='';
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
		...
		me._info_btn_enabled.logicBlock_visible = function() {
			...
			if (me._info_btn_enabled.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				me._info_btn_enabled.style[domTransition]='';
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
		...
		me._share_btn.logicBlock_visible = function() {
			...
			if (me._share_btn.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				me._share_btn.style[domTransition]='';
...
navigator.share({ url: shareUrl });
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
		...
		elo.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
			''+
			'MsMS41LDAuMywzQzIwLjYsMTIuNywyMC40LDEzLjcsMjAuMywxNC4yeiIvPgo8L3N2Zz4K';
		...
		me._vr_btn.logicBlock_visible = function() {
			...
			if (me._vr_btn.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				me._vr_btn.style[domTransition]='';
		...
		me._toggle_gyro_btn.logicBlock_visible = function() {
			...
			if (me._toggle_gyro_btn.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				me._toggle_gyro_btn.style[domTransition]='';
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
		...
		me._toggle_gyro_off.logicBlock_visible = function() {
			...
			if (me._toggle_gyro_off.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				me._toggle_gyro_off.style[domTransition]='';
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
		...
		me._toggle_gyro_on.logicBlock_visible = function() {
			...
			if (me._toggle_gyro_on.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				me._toggle_gyro_on.style[domTransition]='';
		...
		me._toggle_autorot_btn.logicBlock_visible = function() {
			...
			if (me._toggle_autorot_btn.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				me._toggle_autorot_btn.style[domTransition]='';
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
			''+
			''+
			''+
			''+
			'OS41LDUuM0M5LjMsNS40LDkuMiw1LjQsOS4xLDUuNUM5LDUuNiw4LjksNS42LDguOCw1Ljd6Ii8+Cjwvc3ZnPgo=';
		...
		elo.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
			''+
			''+
			''+
			''+
		...
		me._toggle_autorot_off.logicBlock_visible = function() {
			...
			if (me._toggle_autorot_off.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				me._toggle_autorot_off.style[domTransition]='';
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
			''+
			''+
			'';
		...
		elo.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
			''+
			''+
			'';
		...
		me._toggle_autorot_on.logicBlock_visible = function() {
			...
			if (me._toggle_autorot_on.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				me._toggle_autorot_on.style[domTransition]='';
		...
		me._toggle_audio_btn.logicBlock_visible = function() {
			...
			if (me._toggle_audio_btn.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				me._toggle_audio_btn.style[domTransition]='';
		...
		me._toggle_audio_off.logicBlock_visible = function() {
			...
			if (me._toggle_audio_off.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				me._toggle_audio_off.style[domTransition]='';
		...
		me._toggle_audio_on.logicBlock_visible = function() {
			...
			if (me._toggle_audio_on.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				me._toggle_audio_on.style[domTransition]='';
		...
		me._toggle_fullscreen_btn.logicBlock_visible = function() {
			...
			if (me._toggle_fullscreen_btn.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				me._toggle_fullscreen_btn.style[domTransition]='';
		...
		me._toggle_fullscreen_off.logicBlock_visible = function() {
			...
			if (me._toggle_fullscreen_off.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				me._toggle_fullscreen_off.style[domTransition]='';
		...
		me._toggle_fullscreen_on.logicBlock_visible = function() {
			...
			if (me._toggle_fullscreen_on.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				me._toggle_fullscreen_on.style[domTransition]='';
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
			''+
			''+
			'';
		...
		elo.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
			''+
			''+
			'';
		...
		me._language_btn.logicBlock_visible = function() {
			...
			if (me._language_btn.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				me._language_btn.style[domTransition]='';
		...
		elo.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
		...
		me._thumbs_btn.logicBlock_visible = function() {
			...
			if (me._thumbs_btn.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				me._thumbs_btn.style[domTransition]='';
		...
		me._toggle_controls.logicBlock_visible = function() {
			...
			if (me._toggle_controls.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				me._toggle_controls.style[domTransition]='';
		...
		me._toggle_controls_off.logicBlock_visible = function() {
			...
			if (me._toggle_controls_off.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				me._toggle_controls_off.style[domTransition]='';
		...
		me._toggle_controls_on.logicBlock_visible = function() {
			...
			if (me._toggle_controls_on.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				me._toggle_controls_on.style[domTransition]='';
		...
		me._languages.logicBlock_visible = function() {
			...
			if (me._languages.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				me._languages.style[domTransition]='opacity 300ms ease 0ms';
		...
		me._languages_cloner.callChildLogicBlocks_mouseover = function(){
			if(me._languages_cloner.ggInstances) {
				...
				for(i = 0; i < me._languages_cloner.ggInstances.length; i++) {
					if (me._languages_cloner.ggInstances[i]._language_title_bg && me._languages_cloner.ggInstances[i]._language_title_bg.logicBlock_backgroundcolor) {
						me._languages_cloner.ggInstances[i]._language_title_bg.logicBlock_backgroundcolor();
					}
				}
			}
		}
		...
		me._thumbs.logicBlock_visible = function() {
			...
			if (me._thumbs.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				me._thumbs.style[domTransition]='opacity 300ms ease 0ms';
		...
		els.ontouchstart = function(e) {
			e = e || window.event;
			var t = e.touches;
			me._thumbs_scroller.ggDragLastX = t ? t[0].clientX : e.clientX;
			me._thumbs_scroller.ggDragLastY = t ? t[0].clientY : e.clientY;
			me._thumbs_scroller__content.ontouchend = function() {
				let inertiaInterval = setInterval(function() {
		...
		if (player.getOS() == 1 && navigator.maxTouchPoints > 0) {
			...
			me._thumbs_scroller__content.ontouchmove = function(e) {
				e = e || window.event;
				e.preventDefault();
				var t = e.touches;
				var diffX = ((t ? t[0].clientX : e.clientX) - me._thumbs_scroller.ggDragLastX) * me._thumbs_scroller.ggHPercentVisible;
				var diffY = ((t ? t[0].clientY : e.clientY) - me._thumbs_scroller.ggDragLastY) * me._thumbs_scroller.ggVPercentVisible;
		...
		me._thumbs_scroller.ggUpdatePosition=function (useTransition) {
			...
			var scaleY = this.getBoundingClientRect().height / this.offsetHeight;
				...
				if(horScrollWasVisible != me._thumbs_scroller.ggHorScrollVisible || vertScrollWasVisible != me._thumbs_scroller.ggVertScrollVisible) {
					me.updateSize(me._thumbs_scroller);
		...
		el.ggFilter = [];
		el.ggInstances = [];
		me._thumbs_cloner.callChildLogicBlocks_mouseover = function(){
			if(me._thumbs_cloner.ggInstances) {
				var i;
				for(i = 0; i < me._thumbs_cloner.ggInstances.length; i++) {
					if (me._thumbs_cloner.ggInstances[i]._thumb_title_bg && me._thumbs_cloner.ggInstances[i]._thumb_title_bg.logicBlock_backgroundcolor) {
						me._thumbs_cloner.ggInstances[i]._thumb_title_bg.logicBlock_backgroundcolor();
					}
				}
			}
		}
		me._thumbs_cloner.callChildLogicBlocks_active = function(){
			if(me._thumbs_cloner.ggInstances) {
				var i;
				for(i = 0; i < me._thumbs_cloner.ggInstances.length; i++) {
					if (me._thumbs_cloner.ggInstances[i]._thumb_visited && me._thumbs_cloner.ggInstances[i]._thumb_visited.logicBlock_visible) {
						me._thumbs_cloner.ggInstances[i]._thumb_visited.logicBlock_visible();
					}
				}
			}
		}
		me._thumbs_cloner.callChildLogicBlocks_changevisitednodes = function(){
			if(me._thumbs_cloner.ggInstances) {
				var i;
				for(i = 0; i < me._thumbs_cloner.ggInstances.length; i++) {
					if (me._thumbs_cloner.ggInstances[i]._thumb_visited && me._thumbs_cloner.ggInstances[i]._thumb_visited.logicBlock_visible) {
		...
		el.ggUpdate = function(filter) {
			...
			for (var i=0; i < tourNodes.length; i++) {
				...
				if (passed) {
				var parameter={};
				parameter.top=(row * me._thumbs_cloner.ggHeight) + 'px';
				parameter.left=(column * me._thumbs_cloner.ggWidth) + 'px';
				parameter.width='100%';
			...
			me._thumbs_cloner.callChildLogicBlocks_mouseover();
			me._thumbs_cloner.callChildLogicBlocks_active();
			me._thumbs_cloner.callChildLogicBlocks_changevisitednodes();
			me._thumbs_cloner.ggUpdating = false;
			player.triggerEvent('clonerchanged');
			if (me._thumbs_cloner.parentNode.classList.contains('ggskin_subelement') && me._thumbs_cloner.parentNode.parentNode.classList.contains('ggskin_scrollarea')) me._thumbs_cloner.parentNode.parentNode.ggUpdatePosition();
		}
		el.ggFilter = [];
		...
		me._thumbs_cloner.ggNodeChange=function () {
		...
		me._share.logicBlock_visible = function() {
			...
			if (me._share.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				me._share.style[domTransition]='opacity 300ms ease 0ms';
		...
		me._copy_btn.logicBlock_visible = function() {
			...
			if (me._copy_btn.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				me._copy_btn.style[domTransition]='';
...
alert("The current view has been copied.");
		...
		elo.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
			''+
			'AuNUMxNi40LDQuOCwxNS45LDUuMywxNS4yLDUuOHoiIGlkPSJ3aGl0ZV9iYWNrZ3JvdW5kIi8+CiA8L2c+Cjwvc3ZnPgo=';
		...
		me._twitter_btn.logicBlock_visible = function() {
			...
			if (me._twitter_btn.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				me._twitter_btn.style[domTransition]='';
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
		...
		me._facebook_btn.logicBlock_visible = function() {
			...
			if (me._facebook_btn.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				me._facebook_btn.style[domTransition]='';
		...
		me._info.logicBlock_visible = function() {
			...
			if (me._info.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				me._info.style[domTransition]='opacity 300ms ease 0ms';
		...
		me._info_text.ggUpdateText=function() {
			var hs="<b class=\'info_headline\'>"+me.ggUserdata.title+"<\/b><p class=\'info_text\'>"+me.ggUserdata.description+"<\/p>";
			if (hs!=this.ggText) {
				this.ggText=hs;
				this.ggTextDiv.innerHTML=hs;
				if (this.ggUpdatePosition) this.ggUpdatePosition();
		...
		me._floorplan.logicBlock_visible = function() {
			...
			if (me._floorplan.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				me._floorplan.style[domTransition]='opacity 500ms ease 0ms';
		...
		me._map.logicBlock_visible = function() {
			...
			if (me._map.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				me._map.style[domTransition]='opacity 500ms ease 0ms';
		...
		me._cloner_container.logicBlock_size = function() {
			...
			if (me._cloner_container.ggCurrentLogicStateSize != newLogicStateSize) {
				...
				me._cloner_container.style[domTransition]='width 0s, height 0s, opacity 500ms ease 0ms';
		...
		el.ggFilter = [];
		el.ggInstances = [];
		me._categories_cloner.callChildLogicBlocks_mouseover = function(){
			if(me._categories_cloner.ggInstances) {
				var i;
				for(i = 0; i < me._categories_cloner.ggInstances.length; i++) {
					if (me._categories_cloner.ggInstances[i]._category_bg && me._categories_cloner.ggInstances[i]._category_bg.logicBlock_backgroundcolor) {
						me._categories_cloner.ggInstances[i]._category_bg.logicBlock_backgroundcolor();
					}
					me._categories_cloner.ggInstances[i]._nodes_cloner.callChildLogicBlocks_mouseover();
				}
			}
		}
		me._categories_cloner.callChildLogicBlocks_mouseover = function(){
			if(me._categories_cloner.ggInstances) {
				var i;
				for(i = 0; i < me._categories_cloner.ggInstances.length; i++) {
					if (me._categories_cloner.ggInstances[i]._nodes_scroller && me._categories_cloner.ggInstances[i]._nodes_scroller.logicBlock_visible) {
						me._categories_cloner.ggInstances[i]._nodes_scroller.logicBlock_visible();
					}
				}
			}
		}
		me._categories_cloner.callChildLogicBlocks_active = function(){
			if(me._categories_cloner.ggInstances) {
				var i;
				for(i = 0; i < me._categories_cloner.ggInstances.length; i++) {
					me._categories_cloner.ggInstances[i]._nodes_cloner.callChildLogicBlocks_active();
				}
			}
		}
		me._categories_cloner.callChildLogicBlocks_changevisitednodes = function(){
			if(me._categories_cloner.ggInstances) {
				var i;
				for(i = 0; i < me._categories_cloner.ggInstances.length; i++) {
					me._categories_cloner.ggInstances[i]._nodes_cloner.callChildLogicBlocks_changevisitednodes();
				}
			}
		}
		el.ggUpdate = function(filter) {
			...
			me._categories_cloner.callChildLogicBlocks_mouseover();
			me._categories_cloner.callChildLogicBlocks_mouseover();
			me._categories_cloner.callChildLogicBlocks_active();
			me._categories_cloner.callChildLogicBlocks_changevisitednodes();
			me._categories_cloner.ggUpdating = false;
			player.triggerEvent('clonerchanged');
		...
		me._categories_cloner.logicBlock_position = function() {
			...
			if (me._categories_cloner.ggCurrentLogicStatePosition != newLogicStatePosition) {
				...
				me._categories_cloner.style[domTransition]='left 0s, top 0s';
		...
		me._pagination_container.logicBlock_visible = function() {
			...
			if (me._pagination_container.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				me._pagination_container.style[domTransition]='';
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,PHN2ZyBmaWxsPSJ3aGl0ZSIgaGVpZ2h0PSIxOHB4IiB3aWR0aD0iMThweCIgdmlld0JveD0iMCAwIDI0IDI0IiB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciPgogPHBhdGggZD0iTTEwIDE3bDUtNS01LTV2MTB6Ii8+CiA8cGF0aCBmaWxsPSJub25lIiBkPSJNMCAyNFYwaDI0djI0SDB6Ii8+Cjwvc3ZnPgo=';
		...
		elo.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			'';
		...
		me._categories_up.logicBlock_visible = function() {
			...
			if (me._categories_up.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				me._categories_up.style[domTransition]='';
		...
		me._categories_up_disabled.logicBlock_visible = function() {
			...
			if (me._categories_up_disabled.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				me._categories_up_disabled.style[domTransition]='';
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,PHN2ZyBmaWxsPSJ3aGl0ZSIgaGVpZ2h0PSIxOHB4IiB3aWR0aD0iMThweCIgdmlld0JveD0iMCAwIDI0IDI0IiB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciPgogPHBhdGggZD0iTTE0IDdsLTUgNSA1IDVWN3oiLz4KIDxwYXRoIGZpbGw9Im5vbmUiIGQ9Ik0yNCAwdjI0SDBWMGgyNHoiLz4KPC9zdmc+Cg==';
		...
		elo.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			'';
		...
		me._categories_down.logicBlock_visible = function() {
			...
			if (me._categories_down.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				me._categories_down.style[domTransition]='';
		...
		me._categories_down_disabled.logicBlock_visible = function() {
			...
			if (me._categories_down_disabled.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				me._categories_down_disabled.style[domTransition]='';
		...
		me._video_controller_seekbar.connectToMediaEl = function() {
			...
			if (me._video_controller_seekbar.mediaEl != null) {
				...
				me._video_controller_seekbar__playhead.style.left = '-3px';
				if (me._video_controller_seekbar.fromBufferSource) {
		...
		me._video_controller_seekbar.ggActivate=function () {
			me._video_controller_button_pause.style[domTransition]='none';
			...
			me._video_controller_button_play.style[domTransition]='none';
		...
		elo.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			'';
		...
		elo.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			'luayI+CiA8c3R5bGUgdHlwZT0idGV4dC9jc3MiPiYjeGQ7Cgkuc3Qwe2ZpbGw6I2FhZmY3Zjt9JiN4ZDsKPC9zdHlsZT4KIDxwYXRoIGNsYXNzPSJzdDAiIGQ9Ik02LDUuMXY3LjhjMCwwLjYsMC43LDEsMS4yLDAuNmw2LjEtMy45YzAuNS0wLjMsMC41LTEsMC0xLjNMNy4yLDQuNUM2LjcsNC4yLDYsNC41LDYsNS4xeiIvPgo8L3N2Zz4K';
		...
		me._pdf_popup.logicBlock_visible = function() {
			...
			if (me._pdf_popup.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				me._pdf_popup.style[domTransition]='';
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
			''+
			''+
			''+
			''+
			'';
		...
		me._popup_close.logicBlock_visible = function() {
			...
			if (me._popup_close.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				me._popup_close.style[domTransition]='';
		...
		me._screentint_phone.logicBlock_visible = function() {
			...
			if (me._screentint_phone.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				me._screentint_phone.style[domTransition]='';
		...
		me._back_to_categories_phone.logicBlock_visible = function() {
			...
			if (me._back_to_categories_phone.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				me._back_to_categories_phone.style[domTransition]='';
		...
		els.ontouchstart = function(e) {
			e = e || window.event;
			var t = e.touches;
			me._nodes_scroller_phone.ggDragLastX = t ? t[0].clientX : e.clientX;
			me._nodes_scroller_phone.ggDragLastY = t ? t[0].clientY : e.clientY;
			me._nodes_scroller_phone__content.ontouchend = function() {
				let inertiaInterval = setInterval(function() {
		...
		if (player.getOS() == 1 && navigator.maxTouchPoints > 0) {
			...
			me._nodes_scroller_phone__content.ontouchmove = function(e) {
				e = e || window.event;
				e.preventDefault();
				var t = e.touches;
				var diffX = ((t ? t[0].clientX : e.clientX) - me._nodes_scroller_phone.ggDragLastX) * me._nodes_scroller_phone.ggHPercentVisible;
				var diffY = ((t ? t[0].clientY : e.clientY) - me._nodes_scroller_phone.ggDragLastY) * me._nodes_scroller_phone.ggVPercentVisible;
		...
		me._nodes_scroller_phone.logicBlock_visible = function() {
			...
			if (me._nodes_scroller_phone.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				me._nodes_scroller_phone.style[domTransition]='';
		...
		me._nodes_scroller_phone.ggUpdatePosition=function (useTransition) {
			...
			var scaleY = this.getBoundingClientRect().height / this.offsetHeight;
				...
				if(horScrollWasVisible != me._nodes_scroller_phone.ggHorScrollVisible || vertScrollWasVisible != me._nodes_scroller_phone.ggVertScrollVisible) {
					me.updateSize(me._nodes_scroller_phone);
		...
		el.ggUpdate = function(filter) {
			...
			for (var i=0; i < tourNodes.length; i++) {
				...
				if (passed) {
				var parameter={};
				parameter.top=(row * me._nodes_cloner_phone.ggHeight) + 'px';
				parameter.left=(column * me._nodes_cloner_phone.ggWidth) + 'px';
			...
			me._nodes_cloner_phone.ggUpdating = false;
			player.triggerEvent('clonerchanged');
			if (me._nodes_cloner_phone.parentNode.classList.contains('ggskin_subelement') && me._nodes_cloner_phone.parentNode.parentNode.classList.contains('ggskin_scrollarea')) me._nodes_cloner_phone.parentNode.parentNode.ggUpdatePosition();
		}
		el.ggFilter = [];
		el.ggFilter[0] = "_nope";
		...
		me._nodes_cloner_phone.ggNodeChange=function () {
		...
		els.ontouchstart = function(e) {
			e = e || window.event;
			var t = e.touches;
			me._categories_scroller_phone.ggDragLastX = t ? t[0].clientX : e.clientX;
			me._categories_scroller_phone.ggDragLastY = t ? t[0].clientY : e.clientY;
			me._categories_scroller_phone__content.ontouchend = function() {
				let inertiaInterval = setInterval(function() {
		...
		if (player.getOS() == 1 && navigator.maxTouchPoints > 0) {
			...
			me._categories_scroller_phone__content.ontouchmove = function(e) {
				e = e || window.event;
				e.preventDefault();
				var t = e.touches;
				var diffX = ((t ? t[0].clientX : e.clientX) - me._categories_scroller_phone.ggDragLastX) * me._categories_scroller_phone.ggHPercentVisible;
				var diffY = ((t ? t[0].clientY : e.clientY) - me._categories_scroller_phone.ggDragLastY) * me._categories_scroller_phone.ggVPercentVisible;
		...
		me._categories_scroller_phone.logicBlock_visible = function() {
			...
			if (me._categories_scroller_phone.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				me._categories_scroller_phone.style[domTransition]='';
		...
		me._categories_scroller_phone.ggUpdatePosition=function (useTransition) {
			...
			var scaleY = this.getBoundingClientRect().height / this.offsetHeight;
				...
				if(horScrollWasVisible != me._categories_scroller_phone.ggHorScrollVisible || vertScrollWasVisible != me._categories_scroller_phone.ggVertScrollVisible) {
					me.updateSize(me._categories_scroller_phone);
		...
		el.ggUpdate = function(filter) {
			...
			for (var i=0; i < el.ggTagTable.length; i++) {
				...
				nodeId['firstnode'] = cItem.firstnode;
				var parameter={};
				parameter.top=(row * me._categories_cloner_phone.ggHeight) + 'px';
				parameter.left=(column * me._categories_cloner_phone.ggWidth) + 'px';
			...
			me._categories_cloner_phone.ggUpdating = false;
			player.triggerEvent('clonerchanged');
			if (me._categories_cloner_phone.parentNode.classList.contains('ggskin_subelement') && me._categories_cloner_phone.parentNode.parentNode.classList.contains('ggskin_scrollarea')) me._categories_cloner_phone.parentNode.parentNode.ggUpdatePosition();
		}
		el.ggFilter = [];
		el.ggTagTable = [
			];
		...
		me._categories_cloner_phone.ggNodeChange=function () {
		...
		me._floorplan_el.callChildLogicBlocksHotspot_map_pin_active = function(){
			if(me._floorplan_el.ggMarkerInstances) {
				var i;
				for(i = 0; i < me._floorplan_el.ggMarkerInstances.length; i++) {
					if (me._floorplan_el.ggMarkerInstances[i]._pin_active && me._floorplan_el.ggMarkerInstances[i]._pin_active.logicBlock_visible) {
						me._floorplan_el.ggMarkerInstances[i]._pin_active.logicBlock_visible();
					}
					if (me._floorplan_el.ggMarkerInstances[i]._pin_normal && me._floorplan_el.ggMarkerInstances[i]._pin_normal.logicBlock_visible) {
						me._floorplan_el.ggMarkerInstances[i]._pin_normal.logicBlock_visible();
					}
				}
			}
		}
		...
		me._floorplan_el.callChildLogicBlocksHotspot_map_pin_active();
		}
		...
		me._map_el.callChildLogicBlocksHotspot_map_pin_active = function(){
			if(me._map_el.ggMarkerInstances) {
				var i;
				for(i = 0; i < me._map_el.ggMarkerInstances.length; i++) {
					if (me._map_el.ggMarkerInstances[i]._pin_active && me._map_el.ggMarkerInstances[i]._pin_active.logicBlock_visible) {
						me._map_el.ggMarkerInstances[i]._pin_active.logicBlock_visible();
					}
					if (me._map_el.ggMarkerInstances[i]._pin_normal && me._map_el.ggMarkerInstances[i]._pin_normal.logicBlock_visible) {
						me._map_el.ggMarkerInstances[i]._pin_normal.logicBlock_visible();
					}
				}
			}
		}
		...
		me._map_el.ggInitMapMarkers=function(updateMapBounds) {
			...
			SkinMarkerOverlay.prototype.draw = function() {
				...
				if (point) {
					...
					this._div.style.top =(point.y - 30) + 'px';
				}
			};
			...
			for (var i=0; i<ids.length;i++) {
				...
				if (player.getMapType(me._map_el.ggMapId) == 'web') {
					...
					gps=player.getNodeMapCoords(ids[i], me._map_el.ggMapId);
				}
				if ((gps.length>=2) && ((gps[0]!=0) || (gps[1]!=0))) {
					var nodeSortObj = {};
					nodeSortObj['id'] = ids[i];
		...
		me._map_el.callChildLogicBlocksHotspot_map_pin_active();
		...
		me._map_el_phone.callChildLogicBlocksHotspot_map_pin_active = function(){
			if(me._map_el_phone.ggMarkerInstances) {
				var i;
				for(i = 0; i < me._map_el_phone.ggMarkerInstances.length; i++) {
					if (me._map_el_phone.ggMarkerInstances[i]._pin_active && me._map_el_phone.ggMarkerInstances[i]._pin_active.logicBlock_visible) {
						me._map_el_phone.ggMarkerInstances[i]._pin_active.logicBlock_visible();
					}
					if (me._map_el_phone.ggMarkerInstances[i]._pin_normal && me._map_el_phone.ggMarkerInstances[i]._pin_normal.logicBlock_visible) {
						me._map_el_phone.ggMarkerInstances[i]._pin_normal.logicBlock_visible();
					}
				}
			}
		}
		...
		me._map_el_phone.callChildLogicBlocksHotspot_map_pin_active();
			this.ggLastActivMarker = null;
			if (this.ggUpdateConditionNodeChange) this.ggUpdateConditionNodeChange();
			this.ggRadar.lastFov = -1;
		}
		...
		me._floorplan_el_phone.callChildLogicBlocksHotspot_map_pin_active = function(){
			if(me._floorplan_el_phone.ggMarkerInstances) {
				var i;
				for(i = 0; i < me._floorplan_el_phone.ggMarkerInstances.length; i++) {
					if (me._floorplan_el_phone.ggMarkerInstances[i]._pin_active && me._floorplan_el_phone.ggMarkerInstances[i]._pin_active.logicBlock_visible) {
						me._floorplan_el_phone.ggMarkerInstances[i]._pin_active.logicBlock_visible();
					}
					if (me._floorplan_el_phone.ggMarkerInstances[i]._pin_normal && me._floorplan_el_phone.ggMarkerInstances[i]._pin_normal.logicBlock_visible) {
						me._floorplan_el_phone.ggMarkerInstances[i]._pin_normal.logicBlock_visible();
					}
				}
			}
		}
		...
		me._floorplan_el_phone.callChildLogicBlocksHotspot_map_pin_active();
		}
   ...
   for (let i=0; i<styleSheets.length; i++) {
      ...
      if (styleSheet.href === null) {
         ...
         for (let j=0; j<cssRules.length; j++) {
			...
			me._share_bg.style[domTransition]='none';
			me._share_bg.style.width = '72px';
			me._share_bg.style.height = '0px';
		...
		player.addListener('playerstatechanged', function() {
			...
			me._language_btn.style[domTransition]='none';
			me._language_btn.ggParameter.rx=0;me._language_btn.ggParameter.ry=0;
			me._language_btn.style[domTransform]=parameterToTransform(me._language_btn.ggParameter);
			player.setVariableValue('pos_languages', Number(player.getVariableValue('pos_menu_button')));
			me._languages.style[domTransition]='none';
			me._languages.ggParameter.rx=0;me._languages.ggParameter.ry=0;
			me._languages.style[domTransform]=parameterToTransform(me._languages.ggParameter);
			if (
				(
					((player.getViewerSize().width > 1))
				)
			...
			me._toggle_fullscreen_btn.style[domTransition]='none';
			me._toggle_fullscreen_btn.ggParameter.rx=0;me._toggle_fullscreen_btn.ggParameter.ry=0;
			me._toggle_fullscreen_btn.style[domTransform]=parameterToTransform(me._toggle_fullscreen_btn.ggParameter);
			if (
				(
					((player.getVariableValue('opt_fullscreen') == true)) && 
					((player.getVariableValue('has_fullscreen') == true))
			...
			me._toggle_audio_btn.style[domTransition]='none';
			me._toggle_audio_btn.ggParameter.rx=0;me._toggle_audio_btn.ggParameter.ry=0;
			me._toggle_audio_btn.style[domTransform]=parameterToTransform(me._toggle_audio_btn.ggParameter);
			if (
				(
					((player.getViewerSize().width == true))
				)
			...
			me._toggle_autorot_btn.style[domTransition]='none';
			me._toggle_autorot_btn.ggParameter.rx=0;me._toggle_autorot_btn.ggParameter.ry=0;
			me._toggle_autorot_btn.style[domTransform]=parameterToTransform(me._toggle_autorot_btn.ggParameter);
			if (
				(
					((player.getVariableValue('opt_autorotation') == true))
				)
			...
			me._toggle_gyro_btn.style[domTransition]='none';
			me._toggle_gyro_btn.ggParameter.rx=0;me._toggle_gyro_btn.ggParameter.ry=0;
			me._toggle_gyro_btn.style[domTransform]=parameterToTransform(me._toggle_gyro_btn.ggParameter);
			if (
				(
					((player.getVariableValue('opt_gyro') == true)) && 
					((player.getGyroAvailable() == true))
			...
			me._vr_btn.style[domTransition]='none';
			me._vr_btn.ggParameter.rx=0;me._vr_btn.ggParameter.ry=0;
			me._vr_btn.style[domTransform]=parameterToTransform(me._vr_btn.ggParameter);
			if (
				(
					((player.hasVR() == true))
				)
			...
			me._share_btn.style[domTransition]='none';
			me._share_btn.ggParameter.rx=0;me._share_btn.ggParameter.ry=0;
			me._share_btn.style[domTransform]=parameterToTransform(me._share_btn.ggParameter);
			player.setVariableValue('pos_share', Number(player.getVariableValue('pos_menu_button')));
			...
			me._info_btn.style[domTransition]='none';
			me._info_btn.ggParameter.rx=0;me._info_btn.ggParameter.ry=0;
			me._info_btn.style[domTransform]=parameterToTransform(me._info_btn.ggParameter);
			player.setVariableValue('pos_info', Number(player.getVariableValue('pos_menu_button')));
			...
			me._map_btn.style[domTransition]='none';
			me._map_btn.ggParameter.rx=0;me._map_btn.ggParameter.ry=0;
			me._map_btn.style[domTransform]=parameterToTransform(me._map_btn.ggParameter);
			player.setVariableValue('pos_map', Number(player.getVariableValue('pos_menu_button')));
			...
			me._floorplan_btn.style[domTransition]='none';
			me._floorplan_btn.ggParameter.rx=0;me._floorplan_btn.ggParameter.ry=0;
			me._floorplan_btn.style[domTransform]=parameterToTransform(me._floorplan_btn.ggParameter);
			player.setVariableValue('pos_floorplan', Number(player.getVariableValue('pos_menu_button')));
			...
			me._floorplan.ggParameter.rx=0;me._floorplan.ggParameter.ry=0;
	...
	me.callChildLogicBlocksHotspot_ht_video_youtube_changenode = function(){
		if(hotspotTemplates['ht_video_youtube']) {
			...
			for(i = 0; i < hotspotTemplates['ht_video_youtube'].length; i++) {
				...
				if (hotspotTemplates['ht_video_youtube'][i]._ht_video_youtube_icon && hotspotTemplates['ht_video_youtube'][i]._ht_video_youtube_icon.logicBlock_visible) {
					hotspotTemplates['ht_video_youtube'][i]._ht_video_youtube_icon.logicBlock_visible();
				}
	...
	me.callChildLogicBlocksHotspot_ht_video_youtube_varchanged_vis_popup = function(){
		if(hotspotTemplates['ht_video_youtube']) {
			var i;
			for(i = 0; i < hotspotTemplates['ht_video_youtube'].length; i++) {
				if (hotspotTemplates['ht_video_youtube'][i]._ht_video_youtube.logicBlock_visible) {
	...
	me.callChildLogicBlocksHotspot_ht_video_vimeo_changenode = function(){
		if(hotspotTemplates['ht_video_vimeo']) {
			...
			for(i = 0; i < hotspotTemplates['ht_video_vimeo'].length; i++) {
				...
				if (hotspotTemplates['ht_video_vimeo'][i]._ht_video_vimeo_icon && hotspotTemplates['ht_video_vimeo'][i]._ht_video_vimeo_icon.logicBlock_visible) {
					hotspotTemplates['ht_video_vimeo'][i]._ht_video_vimeo_icon.logicBlock_visible();
				}
	...
	me.callChildLogicBlocksHotspot_ht_video_vimeo_varchanged_vis_popup = function(){
		if(hotspotTemplates['ht_video_vimeo']) {
			var i;
			for(i = 0; i < hotspotTemplates['ht_video_vimeo'].length; i++) {
				if (hotspotTemplates['ht_video_vimeo'][i]._ht_video_vimeo.logicBlock_visible) {
	...
	me.callChildLogicBlocksHotspot_ht_video_url_changenode = function(){
		if(hotspotTemplates['ht_video_url']) {
			...
			for(i = 0; i < hotspotTemplates['ht_video_url'].length; i++) {
				...
				if (hotspotTemplates['ht_video_url'][i]._ht_video_url_icon && hotspotTemplates['ht_video_url'][i]._ht_video_url_icon.logicBlock_visible) {
					hotspotTemplates['ht_video_url'][i]._ht_video_url_icon.logicBlock_visible();
				}
	...
	me.callChildLogicBlocksHotspot_ht_video_url_varchanged_vis_popup = function(){
		if(hotspotTemplates['ht_video_url']) {
			var i;
			for(i = 0; i < hotspotTemplates['ht_video_url'].length; i++) {
				if (hotspotTemplates['ht_video_url'][i]._ht_video_url.logicBlock_visible) {
	...
	me.callChildLogicBlocksHotspot_ht_video_file_changenode = function(){
		if(hotspotTemplates['ht_video_file']) {
			...
			for(i = 0; i < hotspotTemplates['ht_video_file'].length; i++) {
				...
				if (hotspotTemplates['ht_video_file'][i]._ht_video_file_icon && hotspotTemplates['ht_video_file'][i]._ht_video_file_icon.logicBlock_visible) {
					hotspotTemplates['ht_video_file'][i]._ht_video_file_icon.logicBlock_visible();
				}
	...
	me.callChildLogicBlocksHotspot_ht_video_file_varchanged_vis_popup = function(){
		if(hotspotTemplates['ht_video_file']) {
			var i;
			for(i = 0; i < hotspotTemplates['ht_video_file'].length; i++) {
				if (hotspotTemplates['ht_video_file'][i]._ht_video_file.logicBlock_visible) {
	...
	me.callChildLogicBlocksHotspot_ht_pdf_varchanged_vis_popup = function(){
		if(hotspotTemplates['ht_pdf']) {
			var i;
			for(i = 0; i < hotspotTemplates['ht_pdf'].length; i++) {
				if (hotspotTemplates['ht_pdf'][i]._ht_pdf.logicBlock_visible) {
	...
	me.callChildLogicBlocksHotspot_ht_info_configloaded = function(){
		if(hotspotTemplates['ht_info']) {
			var i;
			for(i = 0; i < hotspotTemplates['ht_info'].length; i++) {
				if (hotspotTemplates['ht_info'][i]._ht_image_tooltip0 && hotspotTemplates['ht_info'][i]._ht_image_tooltip0.logicBlock_position) {
					hotspotTemplates['ht_info'][i]._ht_image_tooltip0.logicBlock_position();
				}
			}
		}
	}
	me.callChildLogicBlocksHotspot_ht_info_mouseover = function(){
		if(hotspotTemplates['ht_info']) {
			var i;
			for(i = 0; i < hotspotTemplates['ht_info'].length; i++) {
				if (hotspotTemplates['ht_info'][i]._ht_image_tooltip0 && hotspotTemplates['ht_info'][i]._ht_image_tooltip0.logicBlock_alpha) {
					hotspotTemplates['ht_info'][i]._ht_image_tooltip0.logicBlock_alpha();
				}
			}
		}
	}
	...
	me.callChildLogicBlocksHotspot_ht_info_varchanged_vis_popup = function(){
		if(hotspotTemplates['ht_info']) {
			var i;
			for(i = 0; i < hotspotTemplates['ht_info'].length; i++) {
				if (hotspotTemplates['ht_info'][i]._ht_info.logicBlock_visible) {
	...
	me.callChildLogicBlocksHotspot_ht_image_varchanged_vis_popup = function(){
		if(hotspotTemplates['ht_image']) {
			var i;
			for(i = 0; i < hotspotTemplates['ht_image'].length; i++) {
				if (hotspotTemplates['ht_image'][i]._ht_image.logicBlock_visible) {
	...
	me.callChildLogicBlocksHotspot_ht_node_varchanged_vis_popup = function(){
		if(hotspotTemplates['ht_node']) {
			var i;
			for(i = 0; i < hotspotTemplates['ht_node'].length; i++) {
				if (hotspotTemplates['ht_node'][i]._ht_node.logicBlock_visible) {
	...
	me.callChildLogicBlocksHotspot_ht_url_varchanged_vis_popup = function(){
		if(hotspotTemplates['ht_url']) {
			var i;
			for(i = 0; i < hotspotTemplates['ht_url'].length; i++) {
				if (hotspotTemplates['ht_url'][i]._ht_url.logicBlock_visible) {
	...
	function SkinHotspotClass_ht_video_youtube(parentScope,hotspot) {
		...
		me._ht_video_youtube.onclick=function (e) {
			...
			if (
				...
				skin._video_youtube_popup_title.ggText=me.hotspot.title;
				skin._video_youtube_popup_title.ggTextDiv.innerHTML=skin._video_youtube_popup_title.ggText;
				if (skin._video_youtube_popup_title.ggUpdateText) {
				...
				if (skin._video_youtube_popup_title.ggUpdatePosition) {
					skin._video_youtube_popup_title.ggUpdatePosition();
				}
		...
		me._ht_video_youtube_tooltip.logicBlock_position = function() {
			...
			if (me._ht_video_youtube_tooltip.ggCurrentLogicStatePosition != newLogicStatePosition) {
				...
				me._ht_video_youtube_tooltip.style[domTransition]='left 0s, top 0s, opacity 300ms ease 0ms';
				if (me._ht_video_youtube_tooltip.ggCurrentLogicStatePosition == 0) {
					...
					me._ht_video_youtube_tooltip.ggDy=26;
					me._ht_video_youtube_tooltip.ggUpdatePosition(true);
				}
			}
		}
	...
	function SkinHotspotClass_ht_video_vimeo(parentScope,hotspot) {
		...
		me._ht_video_vimeo.onclick=function (e) {
			...
			if (
				...
				skin._video_vimeo_popup_title.ggText=me.hotspot.title;
				skin._video_vimeo_popup_title.ggTextDiv.innerHTML=skin._video_vimeo_popup_title.ggText;
				if (skin._video_vimeo_popup_title.ggUpdateText) {
				...
				if (skin._video_vimeo_popup_title.ggUpdatePosition) {
					skin._video_vimeo_popup_title.ggUpdatePosition();
				}
		...
		me._ht_video_vimeo_tooltip.logicBlock_position = function() {
			...
			if (me._ht_video_vimeo_tooltip.ggCurrentLogicStatePosition != newLogicStatePosition) {
				...
				me._ht_video_vimeo_tooltip.style[domTransition]='left 0s, top 0s, opacity 300ms ease 0ms';
				if (me._ht_video_vimeo_tooltip.ggCurrentLogicStatePosition == 0) {
					...
					me._ht_video_vimeo_tooltip.ggDy=26;
					me._ht_video_vimeo_tooltip.ggUpdatePosition(true);
				}
			}
		}
		...
		me._ht_video_vimeo_icon.logicBlock_visible = function() {
			...
			if (me._ht_video_vimeo_icon.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				me._ht_video_vimeo_icon.style[domTransition]='';
	...
	function SkinHotspotClass_ht_video_url(parentScope,hotspot) {
		...
		me._ht_video_url.onclick=function (e) {
			...
			if (
				...
				skin._video_url_popup_title.ggText=me.hotspot.title;
				skin._video_url_popup_title.ggTextDiv.innerHTML=skin._video_url_popup_title.ggText;
				if (skin._video_url_popup_title.ggUpdateText) {
				...
				if (skin._video_url_popup_title.ggUpdatePosition) {
					skin._video_url_popup_title.ggUpdatePosition();
				}
			...
			if (
				...
				skin._video_controller_seekbar.ggText="popup_video_url";
		...
		me._ht_video_url_tooltip.logicBlock_position = function() {
			...
			if (me._ht_video_url_tooltip.ggCurrentLogicStatePosition != newLogicStatePosition) {
				...
				me._ht_video_url_tooltip.style[domTransition]='left 0s, top 0s, opacity 300ms ease 0ms';
				if (me._ht_video_url_tooltip.ggCurrentLogicStatePosition == 0) {
					...
					me._ht_video_url_tooltip.ggDy=26;
					me._ht_video_url_tooltip.ggUpdatePosition(true);
				}
			}
		}
		...
		me._ht_video_url_icon.logicBlock_visible = function() {
			...
			if (me._ht_video_url_icon.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				me._ht_video_url_icon.style[domTransition]='';
	...
	function SkinHotspotClass_ht_video_file(parentScope,hotspot) {
		...
		me._ht_video_file.onclick=function (e) {
			...
			if (
				...
				skin._video_file_popup_title.ggText=me.hotspot.title;
				skin._video_file_popup_title.ggTextDiv.innerHTML=skin._video_file_popup_title.ggText;
				if (skin._video_file_popup_title.ggUpdateText) {
				...
				if (skin._video_file_popup_title.ggUpdatePosition) {
					skin._video_file_popup_title.ggUpdatePosition();
				}
			...
			if (
				...
				skin._video_controller_seekbar.ggText="popup_video_file";
				skin._video_controller_seekbar.ggTextDiv.innerHTML=skin._video_controller_seekbar.ggText;
				if (skin._video_controller_seekbar.ggUpdateText) {
					skin._video_controller_seekbar.ggUpdateText=function() {
						var hs="popup_video_file";
						if (hs!=this.ggText) {
							this.ggText=hs;
							this.ggTextDiv.innerHTML=hs;
							if (this.ggUpdatePosition) this.ggUpdatePosition();
		...
		me._ht_video_file_tooltip.logicBlock_position = function() {
			...
			if (me._ht_video_file_tooltip.ggCurrentLogicStatePosition != newLogicStatePosition) {
				...
				me._ht_video_file_tooltip.style[domTransition]='left 0s, top 0s, opacity 300ms ease 0ms';
				if (me._ht_video_file_tooltip.ggCurrentLogicStatePosition == 0) {
					...
					me._ht_video_file_tooltip.ggDy=26;
					me._ht_video_file_tooltip.ggUpdatePosition(true);
				}
			}
		}
		...
		me._ht_video_file_icon.logicBlock_visible = function() {
			...
			if (me._ht_video_file_icon.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				me._ht_video_file_icon.style[domTransition]='';
	...
	function SkinHotspotClass_ht_pdf(parentScope,hotspot) {
		...
		me._ht_pdf_tooltip.logicBlock_position = function() {
			...
			if (me._ht_pdf_tooltip.ggCurrentLogicStatePosition != newLogicStatePosition) {
				...
				me._ht_pdf_tooltip.style[domTransition]='left 0s, top 0s, opacity 300ms ease 0ms';
	...
	function SkinHotspotClass_ht_info(parentScope,hotspot) {
		...
		me._ht_info.onclick=function (e) {
			...
			if (
				...
				me._ht_info_triangle.style[domTransition]='none';
		...
		hs+="max-height: 300px";
		els.setAttribute('style',hs);
		els.innerHTML="<b class=\'plex_sans_medium\' style=\'font-size: 16px\'>"+me.hotspot.title+"<\/b><p class=\'info_text\'>"+me.hotspot.description+"<\/p>";
		el.appendChild(els);
		...
		me._ht_info_icon.ontouchend=function (e) {
			me.elementMouseOver['ht_info_icon']=false;
			me._ht_image_tooltip0.logicBlock_alpha();
		}
		...
		me._ht_image_tooltip0.logicBlock_position = function() {
			...
			if (me._ht_image_tooltip0.ggCurrentLogicStatePosition != newLogicStatePosition) {
				...
				me._ht_image_tooltip0.style[domTransition]='left 0s, top 0s, opacity 300ms ease 0ms';
				if (me._ht_image_tooltip0.ggCurrentLogicStatePosition == 0) {
					this.ggDx = 0;
					this.ggDy = -30;
					me._ht_image_tooltip0.ggUpdatePosition(true);
				}
				else {
					me._ht_image_tooltip0.ggDx=0;
					me._ht_image_tooltip0.ggDy=26;
					me._ht_image_tooltip0.ggUpdatePosition(true);
				}
			}
		}
	...
	function SkinHotspotClass_ht_image(parentScope,hotspot) {
		...
		me._ht_image.onclick=function (e) {
			if (
				...
				me._ht_image_bg.style[domTransition]='none';
			...
			if (
				...
				me._ht_image_triangle.style[domTransition]='none';
		...
		me._ht_image_icon.ontouchend=function (e) {
			me.elementMouseOver['ht_image_icon']=false;
			me._ht_image_tooltip.logicBlock_alpha();
		}
		...
		me._ht_image_tooltip.logicBlock_position = function() {
			...
			if (me._ht_image_tooltip.ggCurrentLogicStatePosition != newLogicStatePosition) {
				...
				me._ht_image_tooltip.style[domTransition]='left 0s, top 0s, opacity 300ms ease 0ms';
	...
	function SkinHotspotClass_ht_url(parentScope,hotspot) {
		...
		me._ht_url.onclick=function (e) {
			...
			if (
				...
				skin._popup_url.ggText="<iframe src=\""+me.hotspot.url+"\" width=\"100%\" height=\"100%\" allowfullscreen=\"true\" mozallowfullscreen=\"true\" webkitallowfullscreen=\"true\" frameborder= \"0\" ><\/iframe>";
				skin._popup_url.ggTextDiv.innerHTML=skin._popup_url.ggText;
				if (skin._popup_url.ggUpdateText) {
				...
				if (skin._popup_url.ggUpdatePosition) {
					skin._popup_url.ggUpdatePosition();
				}
	...
	me.addSkinHotspot=function(hotspot) {
		...
		if (hotspot.skinid=='ht_video_youtube') {
			...
			me.callChildLogicBlocksHotspot_ht_video_youtube_varchanged_vis_popup();;
		...
		if (hotspot.skinid=='ht_video_vimeo') {
			...
			me.callChildLogicBlocksHotspot_ht_video_vimeo_varchanged_vis_popup();;
		...
		if (hotspot.skinid=='ht_video_url') {
			...
			me.callChildLogicBlocksHotspot_ht_video_url_varchanged_vis_popup();;
		...
		if (hotspot.skinid=='ht_video_file') {
			...
			me.callChildLogicBlocksHotspot_ht_video_file_varchanged_vis_popup();;
		...
		if (hotspot.skinid=='ht_pdf') {
			...
			me.callChildLogicBlocksHotspot_ht_pdf_varchanged_vis_popup();;
		...
		if (hotspot.skinid=='ht_info') {
			...
			me.callChildLogicBlocksHotspot_ht_info_varchanged_vis_popup();;
		...
		if (hotspot.skinid=='ht_image') {
			...
			me.callChildLogicBlocksHotspot_ht_image_varchanged_vis_popup();;
		...
		if (hotspot.skinid=='ht_node') {
			...
			me.callChildLogicBlocksHotspot_ht_node_varchanged_vis_popup();;
		...
		} else
		{
			...
			me.callChildLogicBlocksHotspot_ht_url_varchanged_vis_popup();;
	...
	function SkinElement_map_pin_Class(parentScope,ggParent) {
		...
		me._map_pin.onmouseover=function (e) {
			if (
				...
				if (player.transitionsDisabled) {
					me._pin_title.style[domTransition]='none';
				} else {
					me._pin_title.style[domTransition]='all 200ms ease-out 0ms';
				}
		...
		me._pin_active.logicBlock_visible = function() {
			...
			if (me._pin_active.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				me._pin_active.style[domTransition]='';
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
		...
		me._pin_normal.logicBlock_visible = function() {
			...
			if (me._pin_normal.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				me._pin_normal.style[domTransition]='';
	...
	function SkinCloner_categories_cloner_Class(item, parentScope,ggParent,parameter) {
		...
		me.__div.setAttribute('style','position: absolute;width: 173px; height: 28px; visibility: inherit; overflow: visible;');
		...
		me._category_container.ontouchend=function (e) {
			me.elementMouseOver['category_container']=false;
			me._nodes_scroller.logicBlock_visible();
		}
		...
		me._nodes_scroller.logicBlock_visible = function() {
			...
			if (me._nodes_scroller.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				me._nodes_scroller.style[domTransition]='';
		...
		el.ggFilter = [];
		el.ggInstances = [];
		me._nodes_cloner.callChildLogicBlocks_mouseover = function(){
			if(me._nodes_cloner.ggInstances) {
				var i;
				for(i = 0; i < me._nodes_cloner.ggInstances.length; i++) {
					if (me._nodes_cloner.ggInstances[i]._node_title_bg && me._nodes_cloner.ggInstances[i]._node_title_bg.logicBlock_backgroundcolor) {
						me._nodes_cloner.ggInstances[i]._node_title_bg.logicBlock_backgroundcolor();
					}
				}
			}
		}
		me._nodes_cloner.callChildLogicBlocks_active = function(){
			if(me._nodes_cloner.ggInstances) {
				var i;
				for(i = 0; i < me._nodes_cloner.ggInstances.length; i++) {
					if (me._nodes_cloner.ggInstances[i]._node_visited && me._nodes_cloner.ggInstances[i]._node_visited.logicBlock_visible) {
						me._nodes_cloner.ggInstances[i]._node_visited.logicBlock_visible();
					}
				}
			}
		}
		me._nodes_cloner.callChildLogicBlocks_changevisitednodes = function(){
			if(me._nodes_cloner.ggInstances) {
				var i;
				for(i = 0; i < me._nodes_cloner.ggInstances.length; i++) {
					if (me._nodes_cloner.ggInstances[i]._node_visited && me._nodes_cloner.ggInstances[i]._node_visited.logicBlock_visible) {
		...
		el.ggUpdate = function(filter) {
			...
			for (var i=0; i < tourNodes.length; i++) {
				...
				if (passed) {
				var parameter={};
				parameter.top=(row * me._nodes_cloner.ggHeight) + 'px';
				parameter.left=(column * me._nodes_cloner.ggWidth) + 'px';
			...
			me._nodes_cloner.callChildLogicBlocks_mouseover();
			me._nodes_cloner.callChildLogicBlocks_active();
			me._nodes_cloner.callChildLogicBlocks_changevisitednodes();
			me._nodes_cloner.ggUpdating = false;
			player.triggerEvent('clonerchanged');
		...
		me._nodes_cloner.ggNodeChange=function () {
		...
		me._category_bg.logicBlock_backgroundcolor = function() {
			...
			if (me._category_bg.ggCurrentLogicStateBackgroundColor != newLogicStateBackgroundColor) {
				...
				me._category_bg.style[domTransition]='background-color 0s';
		...
		me._category_bg.ontouchend=function (e) {
			me.elementMouseOver['category_bg']=false;
			me._category_bg.logicBlock_backgroundcolor();
		}
	...
	function SkinCloner_languages_cloner_Class(nodeId, parentScope,ggParent,parameter) {
		...
		me.elementMouseOver={};
		me.__div=document.createElement('div');
		me.__div.setAttribute('style','position: absolute;width: 213px; height: 28px; visibility: inherit; overflow: visible;');
		me.__div.style.left=parameter.left;
		me.__div.style.top=parameter.top;
		me.__div.style.width=parameter.width;
		me.__div.style.height=parameter.height;
		...
		me._language_title_bg.logicBlock_backgroundcolor = function() {
			...
			if (me._language_title_bg.ggCurrentLogicStateBackgroundColor != newLogicStateBackgroundColor) {
				...
				me._language_title_bg.style[domTransition]='background-color 0s';
		...
		me._language_title_bg.ontouchend=function (e) {
			me.elementMouseOver['language_title_bg']=false;
			me._language_title_bg.logicBlock_backgroundcolor();
		}
	...
	function SkinCloner_thumbs_cloner_Class(nodeId, parentScope,ggParent,parameter) {
		...
		me._thumb_title_bg.logicBlock_backgroundcolor = function() {
			...
			if (me._thumb_title_bg.ggCurrentLogicStateBackgroundColor != newLogicStateBackgroundColor) {
				...
				me._thumb_title_bg.style[domTransition]='background-color 0s';
		...
		me._thumb_title_bg.ontouchend=function (e) {
			me.elementMouseOver['thumb_title_bg']=false;
			me._thumb_title_bg.logicBlock_backgroundcolor();
		}
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			'8+Cjwvc3ZnPgo=';
		...
		me._thumb_visited.logicBlock_visible = function() {
			...
			if (me._thumb_visited.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				me._thumb_visited.style[domTransition]='';
	...
	function SkinCloner_nodes_cloner_phone_Class(nodeId, parentScope,ggParent,parameter) {
		...
		me.elementMouseOver={};
		me.__div=document.createElement('div');
		me.__div.setAttribute('style','position: absolute;width: 150px; height: 100px; visibility: inherit; overflow: visible;');
		me.__div.style.left=parameter.left;
		me.__div.style.top=parameter.top;
		me.__div.style.width=parameter.width;
		me.__div.style.height=parameter.height;
	...
	function SkinCloner_nodes_cloner_Class(nodeId, parentScope,ggParent,parameter) {
		...
		me.elementMouseOver={};
		me.__div=document.createElement('div');
		me.__div.setAttribute('style','position: absolute;width: 170px; height: 28px; visibility: inherit; overflow: visible;');
		me.__div.style.left=parameter.left;
		me.__div.style.top=parameter.top;
		me.__div.style.width=parameter.width;
		me.__div.style.height=parameter.height;
		...
		me._node_title_bg.logicBlock_backgroundcolor = function() {
			...
			if (me._node_title_bg.ggCurrentLogicStateBackgroundColor != newLogicStateBackgroundColor) {
				...
				me._node_title_bg.style[domTransition]='background-color 0s';
		...
		me._node_title_bg.ontouchend=function (e) {
			me.elementMouseOver['node_title_bg']=false;
			me._node_title_bg.logicBlock_backgroundcolor();
		}
	...
	player.addListener('sizechanged', function(args) { me._toggle_audio_btn.logicBlock_visible();me._language_btn.logicBlock_visible(); });
	player.addListener('fullscreenenter', function(args) { me._toggle_fullscreen_off.logicBlock_visible();me._toggle_fullscreen_on.logicBlock_visible(); });
	player.addListener('fullscreenexit', function(args) { me._toggle_fullscreen_off.logicBlock_visible();me._toggle_fullscreen_on.logicBlock_visible(); });
	player.addListener('changenode', function(args) { me._control_buttons.logicBlock_visible();me._control_buttons.logicBlock_alpha();me._floorplan_btn.logicBlock_visible();me._map_btn.logicBlock_visible();me._info_btn.logicBlock_visible();me._info_btn_disabled.logicBlock_visible();me._info_btn_enabled.logicBlock_visible();me._share_btn.logicBlock_visible();me._toggle_gyro_btn.logicBlock_visible();me._toggle_gyro_off.logicBlock_visible();me._toggle_gyro_on.logicBlock_visible();me._toggle_autorot_btn.logicBlock_visible();me._toggle_autorot_off.logicBlock_visible();me._toggle_autorot_on.logicBlock_visible();me._toggle_audio_off.logicBlock_visible();me._toggle_audio_on.logicBlock_visible();me._toggle_fullscreen_btn.logicBlock_visible();me._thumbs_btn.logicBlock_visible();me._toggle_controls.logicBlock_visible();me._toggle_controls_off.logicBlock_visible();me._toggle_controls_on.logicBlock_visible();me._languages.logicBlock_visible();me._languages.logicBlock_alpha();me._thumbs.logicBlock_visible();me._thumbs.logicBlock_alpha();me._share.logicBlock_visible();me._share.logicBlock_alpha();me._copy_btn.logicBlock_visible();me._twitter_btn.logicBlock_visible();me._facebook_btn.logicBlock_visible();me._info.logicBlock_visible();me._info.logicBlock_alpha();me._floorplan.logicBlock_visible();me._floorplan.logicBlock_alpha();me._map.logicBlock_visible();me._map.logicBlock_alpha();me._cloner_container.logicBlock_size();me._cloner_container.logicBlock_visible();me._cloner_container.logicBlock_alpha();me._categories_cloner.logicBlock_position();me._categories_cloner.logicBlock_visible();me._pagination_container.logicBlock_visible();me._categories_up.logicBlock_visible();me._categories_up_disabled.logicBlock_visible();me._categories_down.logicBlock_visible();me._categories_down_disabled.logicBlock_visible();me._project_title_phone.logicBlock_visible();me._project_title.logicBlock_visible();me._screentint.logicBlock_visible();me._video_youtube_popup.logicBlock_visible();me._popup_video_youtube.logicBlock_visible();me._video_vimeo_popup.logicBlock_visible();me._popup_video_vimeo.logicBlock_visible();me._video_url_popup.logicBlock_visible();me._popup_video_url.logicBlock_visible();me._video_file_popup.logicBlock_visible();me._popup_video_file.logicBlock_visible();me._video_controller.logicBlock_visible();me._pdf_popup.logicBlock_visible();me._image_popup.logicBlock_visible();me._popup_image.logicBlock_visible();me._url_popup.logicBlock_visible();me._popup_close.logicBlock_visible();me._sounds_splashscreen.logicBlock_visible();me._screentint_phone.logicBlock_visible();me._back_to_categories_phone.logicBlock_visible();me._nodes_scroller_phone.logicBlock_visible();me._categories_scroller_phone.logicBlock_visible();me._info_popup_phone.logicBlock_visible();me._map_el_phone.logicBlock_visible();me._floorplan_el_phone.logicBlock_visible();me._image_popup_phone.logicBlock_visible();me._video_controller_phone.logicBlock_visible();me._youtube_popup_phone.logicBlock_visible();me._vimeo_popup_phone.logicBlock_visible();me._video_file_popup_phone.logicBlock_visible();me._video_url_popup_phone.logicBlock_visible(); });
	player.addListener('configloaded', function(args) { me._toggle_gyro_btn.logicBlock_visible();me._thumbs_btn.logicBlock_visible(); });
	player.addListener('autorotatechanged', function(args) { me._toggle_autorot_off.logicBlock_visible();me._toggle_autorot_on.logicBlock_visible(); });
	player.addListener('gyroavailable', function(args) { me._toggle_gyro_btn.logicBlock_visible(); });
	player.addListener('gyrochanged', function(args) { me._toggle_gyro_off.logicBlock_visible();me._toggle_gyro_on.logicBlock_visible(); });
	player.addListener('vrchanged', function(args) { me._vr_btn.logicBlock_visible(); });
	player.addListener('activehotspotchanged', function(args) { me._info_btn_disabled.logicBlock_visible();me._info_btn_enabled.logicBlock_visible();me._info.logicBlock_alpha(); });
	player.addListener('varchanged_vis_popup', function(args) { me._control_buttons.logicBlock_visible();me._toggle_controls.logicBlock_visible();me._languages.logicBlock_visible();me._thumbs.logicBlock_visible();me._share.logicBlock_visible();me._info.logicBlock_visible();me._floorplan.logicBlock_visible();me._map.logicBlock_visible();me._categories_cloner.logicBlock_visible();me._project_title_phone.logicBlock_visible();me._project_title.logicBlock_visible();me._screentint.logicBlock_visible();me._popup_close.logicBlock_visible(); });
	player.addListener('varchanged_vis_skin', function(args) { me._toggle_controls.logicBlock_visible();me._project_title_phone.logicBlock_visible();me._project_title.logicBlock_visible(); });
	player.addListener('varchanged_vis_controls', function(args) { me._control_buttons.logicBlock_alpha();me._toggle_controls_off.logicBlock_visible();me._toggle_controls_on.logicBlock_visible();me._languages.logicBlock_visible();me._thumbs.logicBlock_visible();me._share.logicBlock_visible();me._info.logicBlock_visible();me._floorplan.logicBlock_visible();me._map.logicBlock_visible();me._cloner_container.logicBlock_alpha(); });
	player.addListener('varchanged_vis_languages', function(args) { me._languages.logicBlock_alpha(); });
	player.addListener('varchanged_vis_thumbs', function(args) { me._thumbs.logicBlock_alpha(); });
	player.addListener('varchanged_vis_share', function(args) { me._share.logicBlock_alpha(); });
	player.addListener('varchanged_vis_info', function(args) { me._info.logicBlock_alpha(); });
	player.addListener('varchanged_vis_floorplan', function(args) { me._floorplan.logicBlock_alpha(); });
	player.addListener('varchanged_vis_map', function(args) { me._map.logicBlock_alpha(); });
	player.addListener('varchanged_vis_pdf_popup', function(args) { me._map.logicBlock_visible();me._pdf_popup.logicBlock_visible(); });
	player.addListener('varchanged_vis_video_youtube_popup', function(args) { me._map.logicBlock_visible();me._video_youtube_popup.logicBlock_visible();me._popup_video_youtube.logicBlock_visible(); });
	player.addListener('varchanged_opt_proj_title', function(args) { me._cloner_container.logicBlock_size();me._project_title_phone.logicBlock_visible();me._project_title.logicBlock_visible(); });
	player.addListener('varchanged_has_categories', function(args) { me._thumbs_btn.logicBlock_visible();me._cloner_container.logicBlock_visible();me._nodes_scroller_phone.logicBlock_visible();me._categories_scroller_phone.logicBlock_visible(); });
	player.addListener('varchanged_resp_phone', function(args) { me._thumbs_btn.logicBlock_visible();me._cloner_container.logicBlock_visible();me._categories_cloner.logicBlock_visible();me._project_title_phone.logicBlock_visible();me._project_title.logicBlock_visible();me._screentint.logicBlock_visible();me._popup_close.logicBlock_visible(); });
	player.addListener('varchanged_vis_video_vimeo_popup', function(args) { me._video_vimeo_popup.logicBlock_visible();me._popup_video_vimeo.logicBlock_visible(); });
	player.addListener('varchanged_vis_video_url_popup', function(args) { me._video_url_popup.logicBlock_visible();me._popup_video_url.logicBlock_visible();me._video_controller.logicBlock_visible(); });
	player.addListener('varchanged_vis_video_file_popup', function(args) { me._video_file_popup.logicBlock_visible();me._popup_video_file.logicBlock_visible();me._video_controller.logicBlock_visible(); });
	...
	player.addListener('varchanged_vis_url_popup', function(args) { me._url_popup.logicBlock_visible(); });
	player.addListener('varchanged_vis_sounds_splashscreen', function(args) { me._sounds_splashscreen.logicBlock_visible(); });
	player.addListener('varchanged_vis_phone_thumbs', function(args) { me._screentint_phone.logicBlock_visible();me._nodes_scroller_phone.logicBlock_visible();me._categories_scroller_phone.logicBlock_visible(); });
	player.addListener('varchanged_vis_phone_info', function(args) { me._screentint_phone.logicBlock_visible();me._info_popup_phone.logicBlock_visible(); });
	player.addListener('varchanged_vis_phone_floorplan', function(args) { me._screentint_phone.logicBlock_visible();me._floorplan_el_phone.logicBlock_visible(); });
	player.addListener('varchanged_vis_phone_map', function(args) { me._screentint_phone.logicBlock_visible();me._map_el_phone.logicBlock_visible(); });
	player.addListener('varchanged_vis_phone_image', function(args) { me._screentint_phone.logicBlock_visible();me._image_popup_phone.logicBlock_visible(); });
	player.addListener('varchanged_vis_phone_pdf', function(args) { me._screentint_phone.logicBlock_visible(); });
	player.addListener('varchanged_vis_phone_youtube', function(args) { me._screentint_phone.logicBlock_visible();me._youtube_popup_phone.logicBlock_visible(); });
	player.addListener('varchanged_vis_phone_vimeo', function(args) { me._screentint_phone.logicBlock_visible();me._vimeo_popup_phone.logicBlock_visible(); });
	player.addListener('varchanged_vis_phone_video_file', function(args) { me._screentint_phone.logicBlock_visible();me._video_controller_phone.logicBlock_visible();me._video_file_popup_phone.logicBlock_visible(); });
	player.addListener('varchanged_vis_phone_video_url', function(args) { me._screentint_phone.logicBlock_visible();me._video_controller_phone.logicBlock_visible();me._video_url_popup_phone.logicBlock_visible(); });
	player.addListener('varchanged_opt_floorplans', function(args) { me._floorplan_btn.logicBlock_visible(); });
	player.addListener('varchanged_opt_maps', function(args) { me._map_btn.logicBlock_visible(); });
	player.addListener('varchanged_opt_info', function(args) { me._info_btn.logicBlock_visible(); });
	player.addListener('varchanged_opt_share', function(args) { me._share_btn.logicBlock_visible(); });
	player.addListener('varchanged_opt_gyro', function(args) { me._toggle_gyro_btn.logicBlock_visible(); });
	player.addListener('varchanged_opt_autorotation', function(args) { me._toggle_autorot_btn.logicBlock_visible(); });
	player.addListener('varchanged_opt_fullscreen', function(args) { me._toggle_fullscreen_btn.logicBlock_visible(); });
	player.addListener('varchanged_has_fullscreen', function(args) { me._toggle_fullscreen_btn.logicBlock_visible(); });
	player.addListener('varchanged_categories_cloner_hasUp', function(args) { me._categories_cloner.logicBlock_position();me._pagination_container.logicBlock_visible();me._categories_up.logicBlock_visible();me._categories_up_disabled.logicBlock_visible(); });
	player.addListener('varchanged_categories_cloner_hasDown', function(args) { me._categories_cloner.logicBlock_position();me._pagination_container.logicBlock_visible();me._categories_down.logicBlock_visible();me._categories_down_disabled.logicBlock_visible(); });
	player.addListener('varchanged_vis_phone_nodes', function(args) { me._back_to_categories_phone.logicBlock_visible();me._nodes_scroller_phone.logicBlock_visible();me._categories_scroller_phone.logicBlock_visible(); });
	player.addListener('varchanged_toggle_audio', function(args) { me._toggle_audio_off.logicBlock_visible();me._toggle_audio_on.logicBlock_visible(); });
	...
	player.addListener('mouseover', function(args) { me._languages_cloner.callChildLogicBlocks_mouseover();me._thumbs_cloner.callChildLogicBlocks_mouseover();me._categories_cloner.callChildLogicBlocks_mouseover(); });
	player.addListener('mouseover', function(args) { me._categories_cloner.callChildLogicBlocks_mouseover(); });
	player.addListener('changenode', function(args) { me._thumbs_cloner.callChildLogicBlocks_active();me._categories_cloner.callChildLogicBlocks_active(); });
	player.addListener('changevisitednodes', function(args) { me._thumbs_cloner.callChildLogicBlocks_changevisitednodes();me._categories_cloner.callChildLogicBlocks_changevisitednodes(); });
	player.addListener('changenode', function(args) { me._floorplan_el.callChildLogicBlocksHotspot_map_pin_active();me._map_el.callChildLogicBlocksHotspot_map_pin_active();me._map_el_phone.callChildLogicBlocksHotspot_map_pin_active();me._floorplan_el_phone.callChildLogicBlocksHotspot_map_pin_active(); });
	...
	player.addListener('varchanged_vis_popup', function(args) { me.callChildLogicBlocksHotspot_ht_video_youtube_varchanged_vis_popup();me.callChildLogicBlocksHotspot_ht_video_vimeo_varchanged_vis_popup();me.callChildLogicBlocksHotspot_ht_video_url_varchanged_vis_popup();me.callChildLogicBlocksHotspot_ht_video_file_varchanged_vis_popup();me.callChildLogicBlocksHotspot_ht_pdf_varchanged_vis_popup();me.callChildLogicBlocksHotspot_ht_info_varchanged_vis_popup();me.callChildLogicBlocksHotspot_ht_image_varchanged_vis_popup();me.callChildLogicBlocksHotspot_ht_node_varchanged_vis_popup();me.callChildLogicBlocksHotspot_ht_url_varchanged_vis_popup(); });
